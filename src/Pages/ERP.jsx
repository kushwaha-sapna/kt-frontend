...
//               <FaBoxes className="text-blue-600" /> Centralized Data Management
//             </li>
//             <li className="flex items-center gap-2">
//               <FaUsers className="text-blue-600" /> Improved Team Collaboration
//             </li>
//             <li className="flex items-center gap-2">
//               <FaChartLine className="text-blue-600" /> Faster Decision Making
//             </li>
//             <li className="flex items-center gap-2">
//               <FaShieldAlt className="text-blue-600" /> Reduced Operational Costs
//             </li>
//           </ul>
//         </div>
